...
def get_external_camera_number():
    
    max_devices = 10

    
    external_camera_number = None
    for i in range(max_devices):
        ...
        if cv2.VideoCapture() == "V4L2":
            external_camera_number = i
            break

    return external_camera_number


external_camera_number = get_external_camera_number()

if external_camera_number is not None:
    print(f"External webcam found at device {external_camera_number}.")
else:
